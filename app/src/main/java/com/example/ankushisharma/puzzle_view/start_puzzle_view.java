...
import com.example.ankushisharma.puzzle_view.Puzzle_view.ShowNumbers;
...
public class start_puzzle_view extends Activity
{
    protected static final int MENU_SCRAMBLE = 0;
    protected static final int MENU_TAKE_PHOTO = 1;
    protected static final int MENU_SHOW_NUMBERS = 2;
    ...
    protected static final String FILENAME_DIR = "com.example.ankushisharma.res.pics";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        view = new Puzzle_view(this, puzzle);
    ...
    private long cal_time(int state){
        if(state == RESULT_OK) {
        ...
        builder.setSingleChoiceItems(LABELS_SHOW_NUMBERS_ITEMS, selected, new OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialog, int which)
            {
                ...
                if(newShowNumbers != oldShowNumbers)
                {
                    ...
                    {
                        Toast.makeText(start_puzzle_view.this, R.string.toast_disabled_expert_mode, Toast.LENGTH_LONG).show();
                        expert = false;
                    }
                    else if(newShowNumbers == ShowNumbers.NONE)
                    {
                        Toast.makeText(start_puzzle_view.this, R.string.toast_not_enabled_expert_mode, Toast.LENGTH_LONG).show();
                    }
                }
    ...
    private void share_puzzle() {
        //dO something
        // share using content provider to friends
    }

    protected SharedPreferences getPreferences()
    {
        return getSharedPreferences(start_puzzle_view.class.getName(), Activity.MODE_PRIVATE);
    }
    @Override
    ...
    {
        return "android.resource://" + start_puzzle_view.class.getPackage().getName() + "/";
    }
