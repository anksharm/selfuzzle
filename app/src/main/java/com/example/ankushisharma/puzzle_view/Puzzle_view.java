...
/**
 * Created by ankushisharma on 11/5/14.
 */

public class Puzzle_view  extends View
{
    ...
    public Puzzle_view(Context context, Puzzle puzzle)
    {
        super(context);
    ...
    {
       start_puzzle_view activity = (start_puzzle_view) getContext();
        activity.onFinish();
    }
